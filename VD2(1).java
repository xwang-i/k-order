...
class City{ //Xinyu Tu
    ...
    public static Comparator<City> com = new Comparator<City>(){
        @Override
...
public class VD2 extends JFrame{//Xinyu Tu
    ...
    private int colNumber = 30;  //21;
    private int rowNumber = 30;  //16;
    private int k = 1;
    ...
    HashMap<HashSet<City>, ArrayList<City> > topCities = new HashMap<HashSet<City>, ArrayList<City>>();
            ...
            for(int j = 0;j<rowNumber;j++){
                if(cities[i][j].state == 1){
                    ...
                    graphics.drawString(String.valueOf(cities[i][j].name), 
                        cities[i][j].centerX() - 8, cities[i][j].centerY() + 8);
                }
            ...
            for(int j = 0;j<rowNumber;j++){
                if(cities[i][j].state == 0){
                    ...
                    if(topCities.containsKey(top)){
                        ...
                        topCities.get(top).add(cities[i][j]);
                    }
                    else{
                        //int y = rnd.nextInt(16,235);
                        //int u = rnd.nextInt(16,240);
                        //int v = rnd.nextInt(16,240);
                        cities[i][j].color = colorList.get(colorIndex);//new Color(y,u,v);
                        colorIndex++;
                        ArrayList<City> points = new ArrayList<City>();
                        points.add(cities[i][j]);
                        topCities.put(top, points);
                    }
                }
            }
        }
